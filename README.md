...
- [coko7/boat](https://github.com/coko7/boat) - ⛵ Basic Opinionated Activity Tracker, a command line interface inspired by bartib.  (3 days ago)
...
- [lemonade-sdk/lemonade](https://github.com/lemonade-sdk/lemonade) - Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk (6 days ago)
- [LostRuins/koboldcpp](https://github.com/LostRuins/koboldcpp) - Run GGUF models easily with a KoboldAI UI. One File. Zero Install. (6 days ago)
